...
If you do not include an abundance of specific instructions for integrating the the ui framework into the existing application then your changes will immediately discarded.
